...
//    ArrayList<Integer> bhai = new ArrayList<>(5);
    ...
    TextView mMatchedPitch;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fetch_song);
        ...
        mPitchTextView = findViewById(R.id.showPitch);
        mMatchedPitch = findViewById(R.id.matchPitch);
        ...
        PitchDetectionHandler pdh = new PitchDetectionHandler() {
            ...
            public void handlePitch(PitchDetectionResult res, AudioEvent e) {
                ...
                if (pitchInHz != -1) {
                    ...
                    Log.d(TAG, "handlePitch: size" + newList.size());
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (matchingValues > 10) {
                        ...
                        mfound.setText("Song Found");

//                        mSendButton.setEnabled(false);
                    }

                    mPitchTextView.setText("Recorded Pitch Values: " + storeData.getSongPitch());
                    mMatchedPitch.setText("Number of Values Matched: " + matchingValues);
